...
public class HttpRight extends AsyncTask<Void, Void, Void> {
    private final Activity parentActivity;
    private final ProgressDialog dialog;
    private final String baseUrl;

    public HttpRight(Activity parentActivity, String ipAddress) {
        this.parentActivity = parentActivity;
        this.baseUrl = "http://" + ipAddress + "/~pi/right.php";
